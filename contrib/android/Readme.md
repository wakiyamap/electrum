...
$ adb shell monkey -p org.electrum-mona.electrum 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum-mona.electrum | cut -c14-19`"
```
...
```
$ adb shell
$ run-as org.electrum-mona.electrum ls /data/data/org.electrum-mona.electrum/files/data
$ run-as org.electrum-mona.electrum cp /data/data/org.electrum-mona.electrum/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
