...
$ adb shell monkey -p org.monacoin.electrum 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.monacoin.electrum | cut -c14-19`"
```
...
```
$ adb shell
$ run-as org.monacoin.electrum ls /data/data/org.monacoin.electrum/files/data
$ run-as org.monacoin.electrum cp /data/data/org.monacoin.electrum/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
