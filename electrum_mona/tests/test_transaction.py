...
#from electrum_mona.plugins.trustedcoin.legacy_tx_format import serialize_tx_in_legacy_format
...
class TestTransaction(ElectrumTestCase):
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual('mona1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k9xvmwr', addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual('mona1sw50qpvnxy8', addr_from_script('6002751e'))
        self.assertEqual('mona1zw508d6qejxtdg4y5r3zarvaryvhm3vz7', addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
